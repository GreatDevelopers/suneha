...
{
if($number == '' or $number=='+919417212503' or $number=='9417212503' or $number=='+919876975500' or $number=='9876975500')
continue;
$tme = time();
$url = mysql_real_escape_string("http://gndec.ac.in/sms/kannel/dlr.php?status=%d&fid=%F&msgid=".$tme."");
$sql="INSERT INTO send_sms (sender, receiver, msgdata,time,dlr_url)
VALUES
('".$_SESSION['username']."','$number','".$msgdata."','".date('Y-m-d,G-i-s')."','".$url."')";
...
mysql_query("INSERT INTO report (receiver,mobile,msgdata,sender,time,msgid)
VALUES ('".$rep_name."','".$number."','".$msgdata."','".$by."','".date('Y-m-d,G-i-s')."','".$tme."')");
...
echo $number. "<br />";
mysql_query("INSERT INTO report (receiver,mobile,msgdata,sender,time,msgid)
VALUES ('NA','".$number."','".$msgdata."','".$by."','".date('Y-m-d,G-i-s')."','".$tme."')");
}
}
mysql_close($con);
