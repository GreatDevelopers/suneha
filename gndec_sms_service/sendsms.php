...
if(isset($_POST['schedule']) or $_POST['schedule_send']=='schedule') {
	...
	echo "<tr><td>Message</td><td><textarea name='msgdata' rows='10' cols='40' onKeyDown='limitText(this.form.msgdata,this.form.countdown,155)' 
onKeyUp='limitText(this.form.limitedtextarea,this.form.countdown,155)'>
</textarea></td></tr>
<tr><td><font size='1'>(Maximum characters: 155)</td></td>
<tr><td>You have</td><td><input readonly type='text' name='countdown' size='3' value='155'> characters left.</td></tr>";
...
if($status->bearerbox==false or $status->sqlbox==false) {
	echo "<div id='error'>SMS Service is currently down, Your messages will be delivered once the SMS service will be Up again. </div>";
}
...
<textarea name="msgdata" rows="10" cols="40" onKeyDown="limitText(this.form.msgdata,this.form.countdown,155);" 
onKeyUp="limitText(this.form.limitedtextarea,this.form.countdown,155);">
