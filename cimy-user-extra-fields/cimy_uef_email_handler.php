...
///////////////insert into ldap a registered user///////////////////////
	include 'ldap_register.php';
///////////////insert into send_sms table //////////////////////////////
$result= mysql_query("Select VALUE from  wp_cimy_uef_data where USER_ID='$user_id'");
	while($row = mysql_fetch_array($result))
  {
  $receiver = $row['VALUE'];
  }
$navsql="INSERT INTO send_sms (sender,receiver,msgdata)
VALUES
('$user_id','$receiver','$welcome_email')";
 mysql_query($navsql) or die (mysql_error());
////////////////END/////////////////////////////////////////////////////
