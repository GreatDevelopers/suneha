...
<?php if ( ! $suppress_groups_list) :?>
	<div class="wrap">
	<h2><?php 
	$groups_caption = ( defined( 'GROUPS_CAPTION_RS' ) ) ? GROUPS_CAPTION_RS : __('API Information', 'scoper');
	echo( $groups_caption );
	...
	if ( isset($results) && count($results) ) {
		...
		<tr><td>sdbhcbshb</td></tr>
		<tr class="thead">
			<th><?php echo __awp('Number'); ?>
			</th>
			<th><?php echo __awp('Message'); ?></th>
