...
<?php if ( ! $suppress_groups_list) :?>
	<div class="wrap">
	<?php 
	//$groups_caption = ( defined( 'GROUPS_CAPTION_RS' ) ) ? GROUPS_CAPTION_RS : __('Welcome! Here are the few guidelines ', 'scoper');
	//echo( $groups_caption );
echo "<font color=\"#21759B\"><p style=\"font-family:Helvetica; font-size:32px;\">Welcome!</p></font>";
echo "<font color=\"#3D3D3D\"><b><p style=\"font-family:Helvetica; font-size:14px;\">Here are the few Guidelines</b></p></font>";
	if( $can_manage_all_groups ) {
	...
	if ( scoper_get_option('display_hints') ) {
		...
		include 'service_instruction.php';
	...
	if ( isset($results) && count($results) ) {
		...
		function DelConfirm(name){
			...
			<?php include 'api_information.php'; include 'account_information.php';?>
			...
			<?php 
			  $res = mysql_query("SELECT receiver,msgdata  FROM sent_sms WHERE sender='$current_user->ID' AND momt='MT' AND account!='NULL'");
			  ?>
			  <table class="rs-member_table" width="100%" border="0" cellspacing="3" cellpadding="3">
		<tr class="thead" >
			<th width="10%" align="left"><?php echo '<font color="#3D3D3D"><p style="font-family:Helvetica; font-size:14px;">Number</p></font>'; ?>
			</th>
			<th width="90%" align="left"><?php echo '<font color="#3D3D3D"><p style="font-family:Helvetica; font-size:14px;">Message</p></font>'; ?></th>
...
echo "<font style=\"font-family:Helvetica; font-size:12px;\">".$ro['receiver']."</font>";
...
echo "<font style=\"font-family:Helvetica; font-size:12px;\">".$ro['msgdata']."</font>";
